...
parser.add_argument('--path', type=str, default='../data/bot_data/')
parser.add_argument('--data_file', type=str, default='music_data_bunch.pkl')
parser.add_argument('--s2s_data_file', type=str, default='s2s_data_bunch.pkl')
...
s2s_data = load_data(args.path, args.data_file, 
